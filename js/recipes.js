    ...
    content.innerHTML = `
            <div class="container mt-4 p-0">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4>Recipes</h4>
                        <small class="text-muted">Create, check and update recipes.</small>
                    </div>
                    <button type="button" class="btn btn-light" onclick="renderAddNewRecipe()">+</button>
                </div>
                <div class="d-flex gap-5 align-items-center mb-3">
                    <div>
                        <input id="search" type="text" class="form-control" placeholder="Search Food">
                    </div>
...
//Tải trang Chi tiết
const renderDetail = () => {
    content.innerHTML = `<div class="base">
                            ...
                            <div class="basicInformation p-3">
                                ...
                                <div class="table">
                                    ...
                                    <div class="value p-2">Our roasted cauliflower salad with turmeric is low in calories and packed with punchy flavor. Turmeric
                            ...
                            <div class="ingredients p-3">
                                ...
                                <div class="item-ingredients">
                                    1 tsp of spices, turmeric, ground (3 g)
                                </div>
                                <div class="item-ingredients">
                                    1 tbsp of olive oil (14 g)
                                </div>
                                <div class="item-ingredients">
                                    100 grams of rice, brown, medium-grain, raw
                                </div>
                                <div class="item-ingredients">
                                    150 grams of edamame, frozen, unprepared
                                </div>
                                <div class="item-ingredients">
                                    1 cup, sections of lemons, raw, without peel (212 g)
                                </div>
                                <div class="item-ingredients">
                                    1 cup slices of cucumber, with peel, raw (104 g)
                                </div>
                                <div class="item-ingredients">
                                    4 tbsps of parsley, fresh (15 g)
                                </div>
                                <div class="item-ingredients">
                                    50 grams of nuts, cashew nuts, oil roasted, with salt added
                                </div>
                                <div class="item-ingredients">
                                    5 tbsps of vinegar, balsamic (80 g)
                                </div>
                                <div class="item-ingredients">
                                    4 tbsps of soy sauce made from soy (tamari) (72 g)
                                </div>
                                <div class="item-ingredients">
                                    1 tablespoon of oil, sesame, salad or cooking (14 g)
                                </div>
                                <div class="item-ingredients">
                                    1 tbsp of sauce, fish, ready-to-serve (18 g)
                                </div>
                                <div class="item-ingredients">
                                    2 tbsps of syrups, maple (40 g)
                                </div>
                            </div>
                            ...
                            <div class="cookingMethod p-2">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="value p-2">STEP 1 Heat the oven to 200C/fan 180C/gas 6. Put the cauliflower in an ovenproof dish or tin, add the turmeric,
